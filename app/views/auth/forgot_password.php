...
<head>
    ...
    <title>Forgot Password - Repository</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="auth-card">
                    ...
                    <form method="post" action="<?= base_url('auth/forgot_password_process') ?>">
                        <div class="mb-3">
                    ...
                    <div class="auth-links">
                        ...
                        <p><a href="<?= base_url('auth/register') ?>">Don't have an account? Sign up</a></p>
